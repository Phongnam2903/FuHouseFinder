                ...
                <body>
                    ...
                    <%@include file="../Partials/Header.jsp" %>
                        <%@include file="../Partials/Navbar.jsp" %>
                                    ...
                                    <form id="filterForm" class="form-inline d-flex mb-3">
                                        <div class="row w-100">
                                            ...
                                            <div class="form-group col-md-12 d-flex justify-content-center mb-3">
                                                <input class="form-control w-50" type="search" id="search"
                                                    placeholder="Enter keywords to search orders" aria-label="Search"
                                                    value="${param.search}">
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select class="form-control" id="filterStatus">
                                                    ...
                                                    <option value="1" ${param.filterStatus=='1' ? 'selected' : '' }>
                                                        Pending</option>
                                                    <option value="2" ${param.filterStatus=='2' ? 'selected' : '' }>
                                                        Solved</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3 mt-3">
                                                <button type="button" onclick="filter()"
                                                    class="btn btn-secondary mb-2">Apply Filters</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="orderTableBody">
                                                <c:forEach var="order" items="${orderL}" varStatus="status">
                                                    <tr>
                                                        <th scope="row">${status.index + 1 + (currentPage - 1) *
                                                            itemsPerPage}</th>
                                                        ...
                                                        <c:if test="${order.statusID == 2}">
                                                            <td>
                                                                <fmt:formatDate value="${order.solvedDate}"
                                                                    pattern="MM/dd/yyyy" />
                                                            </td>
                                                            <!-- SuggestHouse (Khi click sẽ chuyển đến màn hình houseDetail với id của house) -->
                                                            <td>

                                                                <a href="${pageContext.request.contextPath}/houseDetail?id=${order.houseID}"
                                                                    style="text-decoration: none">${order.houseName}</a>
                                                            </td>
                                                        </c:if>
                                                    </tr>
                                                </c:forEach>
                                ...
                                <div class="pagination-container">
                                    <ul class="pagination justify-content-center">
                                        <c:if test="${currentPage > 1}">
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="${pageContext.request.contextPath}/Order?page=${currentPage - 1}"
                                                    aria-label="Previous">
                                                    &laquo; Previous
                                                </a>
                                            </li>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li class="page-item"><a class="page-link"
                                                            href="${pageContext.request.contextPath}/Order?page=${i}">${i}</a>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                            ...
                            <a href="#" class="btn btn-lg btn-danger-custom" data-bs-toggle="modal"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="orderForm" action="${pageContext.request.contextPath}/homePage"
                                                method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="phoneNumber"
                                                        ...
                                                        value="${sessionScope.phoneNumber != null ? sessionScope.phoneNumber : ''}"
                                                        required>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="desire" class="form-label">What is your desire to find
                                                        accommodation? <span class="text-danger">*</span></label>
                                                    <textarea class="form-control" id="desire" rows="3" name="desire"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" form="orderForm" class="btn btn-custom">Submit
                                                Order</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <%@include file="../Partials/Footer.jsp" %>
                                ...
                                <script>
                                    ...
                                    function filter() {
                                        ...
                                        const fromDate = encodeURIComponent(document.getElementById('fromDate').value);
                                        const toDate = encodeURIComponent(document.getElementById('toDate').value);
                                        const filterStatus = encodeURIComponent(document.getElementById('filterStatus').value);
                                        ...
                                        for (let i = 0; i < rows.length; i++) {
                                            ...
                                            const rowOrderContent = cells[0].textContent;
                                            const rowOrderDate = cells[1].textContent;
                                            const rowOrderStatus = cells[2].textContent;

                                            if (rowOrderContent.toLowerCase().includes(search.toLowerCase()) &&
                                                rowOrderDate.toLowerCase().includes(fromDate.toLowerCase()) &&
                                                rowOrderStatus.toLowerCase().includes(filterStatus.toLowerCase())) {
